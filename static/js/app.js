        ...
        if(windowWidth > 0) {
            if ($(document).scrollTop() >= 100) {
                ...
                if($('.do-sticky').length < 1) {
                    $('.company-logo-2 img').attr('src', '../static/img/Cargeeks-logos.png');
                }
            }
            else {
                $('.sticky-header').removeClass('header-shrink');
                if($('.do-sticky').length < 1 && $('.fixed-header').length == 0 && $('.fixed-header2').length == 0) {
                    $('.company-logo-2 img').attr('src', '../static/img/logos/Cargeeks-logos.png');
                } else {
                    $('.company-logo-2 img').attr('src', '../static/img/logos/Cargeeks-logos_black.png');
                }
            }
        } else {
            $('.company-logo-2 img').attr('src', '../static/img/logos/Cargeeks-logos.png');
